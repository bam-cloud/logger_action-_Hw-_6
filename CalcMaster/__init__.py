from CalcMaster.calculations import Calculations  # Manages history of calculations
from CalcMaster.operations import add, subtract, multiply, divide  # Arithmetic operations
from CalcMaster.calculation import Calculation  # Represents a single calculation
from decimal import Decimal  # For high-precision arithmetic
from typing import Callable  # For type hinting callable objects

# Definition of the CalcMasterclass
class CalcMaster:
    @staticmethod
